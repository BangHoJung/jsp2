...
<body>
	...
	<%=person.getName() %>  <%=person.getAge() %> <br><hr><br>
	...
	<jsp:setProperty property="age" name="person1" value="201"/>
	<%=person1.getName() %>  <%=person1.getAge() %> <br><hr><br>
	
	<jsp:useBean id="person2" class="dto.PersonDTO" scope="application"></jsp:useBean>
	<jsp:setProperty property="name" name="person2" value="홍길동1"/>
	<jsp:setProperty property="age" name="person2" value="201"/>
	<%=person2.getName() %>  <%=person2.getAge() %> <br><hr><br>
